...
import {
    ...
    Layout, Type, MessageSquare, History, Settings,
    ChevronRight, Eye, Edit3, Image as ImageIcon, Trash2, Clock
} from 'lucide-react';
...
const AdminDashboard = () => {
    ...
    const fetchInitialData = async () => {
        setIsLoading(true);
        try {
            const [aboutRes, servicesRes, testimonialsRes] = await Promise.all([
