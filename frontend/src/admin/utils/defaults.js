export const SECTION_DEFAULTS = {
    hero: {
        ...
        body: "Ruh'ya is a space to breathe again. To reconnect. To remember your inner truth. A return to presence and the true self.",
        imageUrl: ""
    },
    about: {
        title: "About Me",
    ...
    therapy: {
        ...
        subtitle: "",
        body: "Healing is not only for those in crisis. You don't have to \"be broken\" to benefit from support.\n\nSome come to therapy for:\n- Emotional overwhelm\n- Stress and anxiety\n- Life transitions\n- Relationship challenges\n- Self-understanding\n- Inner confidence and presence\n- Creative or intuitive blocks\n- Exploring deeper personal identity\n\nIn Ruh'ya, therapy is a space for anyone who wants support, clarity, or integration — regardless of background, age, or past experience.",
        imageUrl: ""
    },
    services: {
        title: "Core Services",
    ...
    journey: {
        ...
        subtitle: "Your healing journey starts with a single step. Reach out to schedule your first session.",
        body: "",
        imageUrl: ""
    }
};
